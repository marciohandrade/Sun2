...
private:
			uSNKEY			m_CURKEY;
			//
			uSNKEY			m_dwRLK_SOLAR1;
			uSNKEY			m_dwRLK_SOLAR2;
			uSNKEY			m_dwRLK_LUNAR1;
			uSNKEY			m_dwRLK_LUNAR2;
			uSNKEY			m_dwRLK_A;		// INITIALIZE INPUT ARG0
			uSNKEY			m_dwRLK_B;		// INITIALIZE { MAJOR_VER, MINOR_VER, +a }
...
{
public:
			inline SNKB		GetSendSNKey( SNKey_T keyType ) { return GetSolarSNKey(keyType); }
			inline SNKB		GetRecvSNKey( SNKey_T keyType ) { return GetLunarSNKey(keyType); }

			inline VOID		NextRoundSNKey4Send() { NextRoundSNKey4Solar(); }
			inline VOID		NextRoundSNKey4Recv() { NextRoundSNKey4Lunar(); }
};
