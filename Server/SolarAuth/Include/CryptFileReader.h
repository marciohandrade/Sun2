...
//
//
#ifndef __SCRIPTCODE_IPARSERTEMP_H
#define __SCRIPTCODE_IPARSERTEMP_H

typedef DWORD				eSCRIPT_CODE_TEMP;

class IParserTEMP
{
public:
	virtual BOOL	ILoad( eSCRIPT_CODE_TEMP scriptCode, BYTE* pSTREAM, DWORD dwSize ) = 0;
};

#endif //__SCRIPTCODE_IPARSERTEMP_H
//
//
//
