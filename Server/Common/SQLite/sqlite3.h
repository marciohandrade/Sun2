...
// modify by greenfish
// http://jacking75.cafe24.com/Tip/SQLLite_2007.htm
// make UNICODE version~
typedef int (*sqlite3_callback16)(void*,int,wchar_t**, wchar_t**);
...
int sqlite3_exec16(
  ...
  const wchar_t *zSql,        /* The SQL to be executed */
  sqlite3_callback16 xCallback, /* Invoke this callback routine */
  void *pArg,                   /* First argument to xCallback() */
  wchar_t **pzErrMsg          /* Write error messages here */
);
