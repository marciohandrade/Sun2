#pragma once
#ifndef GAMESERVER_DELAYED_SKILL_ROUTER_H
#define GAMESERVER_DELAYED_SKILL_ROUTER_H
...
#define SKILL_SYSTEM_VERSION_ROUTING_INL
  ...
  //#else
    #include "./SkillSystem/DelayedSkill.inl"
  //#endif
#undef SKILL_SYSTEM_VERSION_ROUTING_INL
//==================================================================================================

#endif //GAMESERVER_DELAYED_SKILL_ROUTER_H