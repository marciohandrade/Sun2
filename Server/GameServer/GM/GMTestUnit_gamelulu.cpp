...
static bool TestUnit4gamelulu(DWORD player_key, const GmCmdTokens& cmd_tokens)
{
    ...
    DISPMSG("My identification is gamelulu, gooooooooooooooooogle\n");
    return true;
}

}; //end of namespace 'nsGM'

bool GMCmdManager::RegisterTestUnit_gamelulu(const HandlerNode** node_array,
...
#define GMHANDLER_MAPPING(activated, korean, english, handler) \
    ...
    {
        GMHANDLER_MAPPING(true, "πŒ¡§øµ", "gamelulu", &TestUnit4gamelulu),
    }; //
