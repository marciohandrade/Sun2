...
static bool TestUnit4youngmoon(DWORD player_key, const GmCmdTokens& cmd_tokens)
{
    ...
    DISPMSG("My identification is youngmoon, gooooooooooooooooogle\n");
    return true;
}

}; //end of namespace 'nsGM'

bool GMCmdManager::RegisterTestUnit_youngmoon(const HandlerNode** node_array,
...
#define GMHANDLER_MAPPING(activated, korean, english, handler) \
    ...
    {
        GMHANDLER_MAPPING(true, "¹®»óÇö", "youngmoon", &TestUnit4youngmoon),
    }; //
