...
static bool TestUnit4SampleUser_Name(DWORD player_key, const GmCmdTokens& cmd_tokens)
{
    ...
    DISPMSG("I am sample handler, gooooooooooooooooogle\n");
    return true;
}

}; //end of namespace 'nsGM'

bool GMCmdManager::RegisterTestUnit_iamsample(const HandlerNode** node_array,
...
#define GMHANDLER_MAPPING(activated, korean, english, handler) \
    ...
    {
        GMHANDLER_MAPPING(true, "³ª»ùÇÃ", "iamsample", &TestUnit4SampleUser_Name),
    }; //
