#pragma once
#ifndef GAMESERVER_TRANSPARENT_ABILITY_H
#define GAMESERVER_TRANSPARENT_ABILITY_H

#include "BaseStatusAbility.h"

//==================================================================================================

class TransparentAbility : public BaseStatusAbility
{
public:
    TransparentAbility();
    virtual ~TransparentAbility();
