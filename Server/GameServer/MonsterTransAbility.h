#pragma once
#ifndef GAMESERVER_MONSTER_TRANS_ABILITY_H
#define GAMESERVER_MONSTER_TRANS_ABILITY_H

#include "Ability.h"

//==================================================================================================

class MonsterTransAbility : public Ability
{
public:
    MonsterTransAbility() {}
    virtual ~MonsterTransAbility() {}
...
#endif //GAMESERVER_MONSTER_TRANS_ABILITY_H