#pragma once
#ifndef GAMESERVER_SUMMON_TO_DEATH_ABILITY_H
#define GAMESERVER_SUMMON_TO_DEATH_ABILITY_H

#include "BaseStatusAbility.h"

//==================================================================================================

class SummonToDeathAbility : public BaseStatusAbility
{
public:
    SummonToDeathAbility() {}
    virtual ~SummonToDeathAbility() {}
...
//virtual
inline bool SummonToDeathAbility::IsValidStateID() const
{
    switch (GetStateID())
    {
