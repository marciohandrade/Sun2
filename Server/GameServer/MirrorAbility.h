#pragma once
#ifndef GAMESERVER_MIRROR_ABILITY_H
#define GAMESERVER_MIRROR_ABILITY_H

#include "BaseStatusAbility.h"

//==================================================================================================

class MirrorAbility : public BaseStatusAbility
{
public:
    MirrorAbility() {}
    virtual ~MirrorAbility() {}
...
//virtual
inline bool MirrorAbility::IsValidStateID() const
{
    switch (GetStateID())
    {
