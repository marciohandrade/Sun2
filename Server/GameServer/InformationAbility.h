#pragma once
#ifndef GAMESERVER_INFORMATION_ABILITY_H
#define GAMESERVER_INFORMATION_ABILITY_H

#include "Ability.h"

//==================================================================================================

class InformationAbility : public Ability
{
public:
    InformationAbility() {}
    virtual ~InformationAbility() {}
...
#endif //GAMESERVER_INFORMATION_ABILITY_H