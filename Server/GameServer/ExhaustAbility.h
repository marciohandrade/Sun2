#pragma once
#ifndef GAMESERVER_EXHAUST_ABILITY_H
#define GAMESERVER_EXHAUST_ABILITY_H

#include "Ability.h"

//==================================================================================================

class ExhaustAbility : public Ability
{
public:
    ExhaustAbility() {}
    virtual ~ExhaustAbility() {}
...
#endif //GAMESERVER_EXHAUST_ABILITY_H