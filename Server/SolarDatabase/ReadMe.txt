========================================================================
    동적 연결 라이브러리 : SolarDatabaseDll 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 SolarDatabaseDll DLL을 만들었습니다.  
이 파일에는 SolarDatabaseDll 응용 프로그램을 구성하는 각각의 파일에
들어 있는 요약 설명이 포함되어 있습니다.


SolarDatabaseDll.vcproj
...
StdAfx.h 및 StdAfx.cpp는
    SolarDatabaseDll.pch라는 이름의 PCH(미리 컴파일된 헤더) 파일과
