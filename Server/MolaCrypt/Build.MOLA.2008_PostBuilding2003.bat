...
@REM -----------------------------------------------------------------------
ECHO BUILD_LIB
	devenv /clean "Debug" /project "MOLA" ".\SunServer.MOLA.2008.sln"
	devenv /clean "Debug - (서버용)" /project "MOLA" ".\SunServer.MOLA.2008.sln"
	devenv /clean "Release" /project "MOLA" ".\SunServer.MOLA.2008.sln"
	devenv /clean "Release - (서버용)" /project "MOLA" ".\SunServer.MOLA.2008.sln"

REM ------------------------------------------------
	devenv /build "Debug" /project "MOLA" ".\SunServer.MOLA.2008.sln"
	ECHO COMPLETED    
REM ------------------------------------------------
	devenv /build "Debug - (서버용)" /project "MOLA" ".\SunServer.MOLA.2008.sln"
	ECHO COMPLETED
REM ------------------------------------------------
	devenv /build "Release" /project "MOLA" ".\SunServer.MOLA.2008.sln"
	ECHO COMPLETED
REM ------------------------------------------------
	devenv /build "Release - (서버용)" /project "MOLA" ".\SunServer.MOLA.2008.sln"
	ECHO COMPLETED
REM ------------------------------------------------
