...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
//
//#ifndef __MOLA_HSEL_REFACTORING__
//
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
...
/*------------------------------------------------*/
	...
	public://Normal Fuctions(but use Macro)
		...
		virtual char	GetCRCConvertChar(void) const	=0;		//Encrypt 가 끝난 후에 crc 값을 Char 형으로 리턴
		virtual short	GetCRCConvertShort(void) const	=0;	//Encrypt 가 끝난 후에 crc 값을 short 형으로 리턴
		virtual __int32	GetCRCConvertInt(void) const	=0;//Encrypt 가 끝난 후에 crc 값을 Int 형으로 리턴

		virtual void	SetKeyCustom(HSEL_KEY IntoKey)	=0;
		virtual void	SetNextKey(void)				=0;
		virtual void	GenerateKeys(HSEL_KEY &IntoKey)	=0;
...
/*------------------------------------------------*/
	...
	public://Normal Fuctions(but use Macro)
		...
		HSEL_KEY			GetNowHSELKey(void)			const{	return Init.Keys;	}
		//////////////////////////////////////////////////////////////
		...
		virtual void	SetKeyCustom(HSEL_KEY IntoKey);
		virtual void	SetNextKey(void);
		virtual void	GenerateKeys(HSEL_KEY &IntoKey);
		//////////////////////////////////////////////////////////////
		virtual __int32 GetVersion(void) {	return this->iVersion; }
		virtual __int32 GetHSELType(void) {	return this->iHSELType; }
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
//
//#else __MOLA_HSEL_REFACTORING__
//
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
//
//#endif __MOLA_HSEL_REFACTORING__
//
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
