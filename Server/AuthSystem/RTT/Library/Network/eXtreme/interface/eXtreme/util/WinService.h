	...
	public:
		static	void					AddEventLog( char* sourceName, EventLogType type, char* format, ... );
				...
				bool					StartDispatcher(
											char* serviceName, FN_StartCallback fnStart, FN_StopCallback fnStop, FN_UpdateCallback fnUpdate = NULL);
				...
				bool					LocalSystemShutdown( LPTSTR msg = 0, DWORD timeout = 20, BOOL bReboot = TRUE );
