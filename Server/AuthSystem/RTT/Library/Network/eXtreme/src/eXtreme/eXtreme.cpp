...
void DefaultErrorHandler( DWORD /*lastError*/, char* /*desc*/ )
{
	//  Nothing to do...
}

bool eXtreme::Initialize( char* mutexName, LPFN_ErrorHandler handler )
{
...
void eXtreme::CallbackErrorHandler( DWORD lastError, char* desc )
{
	lpfnHandler( lastError, desc );
}

DWORD eXtreme::StringToHash( char* target )
{
	DWORD		ch = 0;
