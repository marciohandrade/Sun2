...
/************************ Block Encryption *************************/
void Crypt::SeedEncrypt(BYTE *pbData, DWORD *pdwRoundKey)
{
...
void Crypt::SeedDecrypt(BYTE *pbData, DWORD *pdwRoundKey)
{
    DWORD L0, L1, R0, R1, T0, T1, *K=pdwRoundKey;
...
void Crypt::SeedEncRoundKey(DWORD *pdwRoundKey, BYTE *pbUserKey)
{
