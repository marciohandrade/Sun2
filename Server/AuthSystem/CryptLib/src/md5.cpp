...
void MD5::EncodeString( BYTE* szString, BYTE digest[16] )
{
	MD5		alg;
...
void MD5::EncodeFile( BYTE* szFilename, BYTE digest[16] )
{
	FILE*	file;
	MD5		alg;
	int		len;
...
void MD5::Finalize( BYTE md5Digest[16] )
{
	...
	::strncpy( ( char* )md5Digest, ( char* )DigestToString( m_digest ), 16 );
}
