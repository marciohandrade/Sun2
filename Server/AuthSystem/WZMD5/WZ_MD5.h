...
public:
	...
	static	void	EncodeString( BYTE* szString, int srcLen, BYTE digest[16], BYTE* key, int keyLen );
	static	bool	Compare( BYTE* source, int srcLen, BYTE* encoded, BYTE* key, int keyLen );
