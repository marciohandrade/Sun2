...
bool
Registry::ReadDWORD(char* valueName, unsigned long* buffer)
{
    if(m_key == 0)
    {
        return false;
...
bool
Registry::ReadString(char* valueName, char* buffer)
{
    if(m_key == 0)
    {
        return false;
...
bool
Registry::WriteDWORD(char* valueName, unsigned long& buffer)
{
    if(m_key == 0)
    {
        return false;
...
bool
Registry::WriteString(char* valueName, char* buffer)
{
    if(m_key == 0)
    {
        return false;
