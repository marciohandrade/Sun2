...
void
Console::SetTitle(LPCTSTR title)
{
    ::SetConsoleTitle(title);
}

void
Console::EnableInput(bool flag)
{
    if(flag == true)
...
void
Console::WriteLine(LPTSTR format, ...)
{
    TCHAR   buffer[4092] = {0, };
    va_list args;
...
void
Console::WriteLineNormal(LPTSTR format, ...)
{
    TCHAR   buffer[4092] = {0, };
    va_list args;
...
void
Console::ReadLine(LPTSTR buffer, DWORD bufferSize, DWORD* readLen)
{
    *readLen = 0;
...
void
Console::SetForeAttr(WORD* attr, char c)
{
    switch(c)
    {
...
void
Console::SetBackAttr(WORD* attr, char c)
{
    switch(c)
    {
...
void
Console::OutputString(WORD attr, char* buffer)
{
...
void
Console::ScrollScreenBuffer(int width)
{
    CONSOLE_SCREEN_BUFFER_INFO  consoleScrInfo;
