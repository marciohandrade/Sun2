...
void
WinService::AddEventLog(char* sourceName, EventLogType type, char* format, ...)
{
    char    buffer[1024] = {0, };
    va_list args;
...
bool
WinService::UploadService(char* serviceName, 
                          char* displayName, 
                          char* binaryPath,
                          char* serviceLogin, 
                          char* password, 
...
bool
WinService::RemoveService(char* serviceName)
{
...
bool
WinService::StartDispatcher(char* serviceName,
                            FN_StartCallback fnStart,
                            FN_StopCallback fnStop,
                            FN_UpdateCallback fnUpdate)
{
...
bool
WinService::ChangeServiceInfo(char* netMachine,  char* serviceName,
...
DWORD
WinService::QueryService(char* netMachine, char* serviceName,
...
DWORD
WinService::StartService(char* netMachine, char* serviceName)
{
    ...
    SC_HANDLE handleServerConnect = ::OpenService(handleService, serviceName,
...
DWORD
WinService::StopService(char* netMachine, char* serviceName)
{
    SC_HANDLE handleService = ::OpenSCManager(netMachine, 0, SC_MANAGER_CONNECT);
...
bool
WinService::ConnectNet(char* account, char* password, char* netMachine)
{
    char        temp[128] = {0, };
    NETRESOURCE netInfo;
    ...
    return (::WNetAddConnection2(&netInfo, password, account,
                                 CONNECT_UPDATE_PROFILE | CONNECT_INTERACTIVE) == NO_ERROR);
}

bool
WinService::CancelNet(char* netMachine)
{
    char        temp[128] = {0, };
...
void __stdcall
WinService::ServiceHandler(DWORD status)
{
...
void __stdcall
WinService::ServiceLoop(DWORD /*argc*/, char** /*argv*/)
{
    bool    loop            = true;
...
bool
WinService::LocalSystemReboot(LPTSTR msg, DWORD timeout)
{
    HANDLE handleToken;
