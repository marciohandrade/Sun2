...
OnServiceStart()
{
    ...
    return (TRUE == pAuthFrame->DoInit("./AuthServer.ini",
                                       AuthFrame::DoAllocServerSession,
                                       AuthFrame::DoFreeServerSession,
                                       AuthFrame::DoFreeConnectSession,
                                       AuthFrame::DoAllocClient_NotUsed,
                                       AuthFrame::DoFreeClient_NotUsed,
                                       AuthFrame::DoFreeConnect_NotUsed));
}

void
OnServiceProcess()
{
    AuthFrame::Instance()->DoProcess();
}

bool
OnServiceUpdate()
{
    return (TRUE == AuthFrame::Instance()->DoUpdate());
}

void
OnServiceStop()
{
    AuthFrame::Instance()->DoRelease();
    AuthFrame::DestroyInstance();
