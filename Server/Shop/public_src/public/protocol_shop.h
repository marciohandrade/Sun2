...
struct STStorageEx
{
	...
	long	PriceSeq;
	long	ProductType;						// 단위 상품 유형 - 406인 경우 게임 내에서 보관함 사용하기 불가
	DWORD	DeleteDate;							// 만료시점
};

//보관함 내의 아이템 정보 + 만료시점 추가
struct STStorageNoGiftMessageEx
{
	STStorageNoGiftMessageEx()
	{
		Seq = ItemSeq = GroupCode = ShareFlag = ProductSeq = PriceSeq = ProductType = 0;
		CashPoint = 0;
		ItemType = 0;
...
enum PaymentType
{
	...
	Outbound_FPTOnline			= 6,
	Outbound_WebzenTW			= 7,
	Outbound_WinneronlineTH		= 8,
	Outbound_SUN_JP				= 9,
	Outbound_BT_TH				= 10,
	Outbound_SUN_RU				= 11,
	Outbound_SUN_CN				= 12,
...
// C->S : AR_GB - AccessIP 추가
class MSG_CLIENT_BUYPRODUCT_AR_GB_ADDIP : public MSG_REQUEST_BASE<MSG_CLIENT_BUYPRODUCT_AR_GB_ADDIP>
{
public:
	MSG_CLIENT_BUYPRODUCT_AR_GB_ADDIP(long nGameCode)
		: MSG_REQUEST_BASE<MSG_CLIENT_BUYPRODUCT_AR_GB_ADDIP>(PROTOCOL_CLIENT_BUYPRODUCT_AR_GB_ADDIP)
	{
		GameCode = nGameCode;
		AccountSeq = 0;
		ProductSeq = Class = Level = ServerIndex = SalesZone = CashTypeCode = 0;
...
public:
	int		ServerIndex;							// 서버 번호
	char	AccountID[MAX_ACCOUNT_LENGTH];			// ID
	WCHAR	CharName[MAX_CHARNAME_TW_LENGTH];		// 캐릭터 이름
	double	DeductPrice;							// 차감 캐시
	INT64	ItemNo;									// 아이템 번호
	INT64	OrderNo;								// 주문 번호
	int		OrderQuantity;							// 주문 수량
	DWORD	AccessIP;								// IP 어드레스
};
...
public:
	...
	INT64	ItemNo;									// 아이템 번호
	INT64	OrderNo;								// 주문 번호
	int		OrderNumber;							// 주문 결과 번호
	WCHAR	RetMessage[MAX_RETMESSAGE_LENGTH];		// 주문 결과 메세지
};
...
// C->S : AR_GB
class MSG_CLIENT_GIFTPRODUCT_AR_GB_ADDIP : public MSG_REQUEST_BASE<MSG_CLIENT_GIFTPRODUCT_AR_GB_ADDIP>
{
public:
	MSG_CLIENT_GIFTPRODUCT_AR_GB_ADDIP(long nGameCode) 
		: MSG_REQUEST_BASE<MSG_CLIENT_GIFTPRODUCT_AR_GB_ADDIP>(PROTOCOL_CLIENT_GIFTPRODUCT_AR_GB_ADDIP)		
	{
		GameCode = nGameCode;
		SenderSeq = ReceiverSeq = ProductSeq = InGamePurchaseSeq = SalesZone = 0;
		SendClass = SendLevel = SendServerIndex = RevClass = RevLevel = RevServerIndex = CashTypeCode = 0;
...
public:
	char	SenderID[MAX_ACCOUNT_LENGTH];			// 발신자 ID
	DWORD	SenderSeq;								// 발신자 순번
	char	ReceiverID[MAX_ACCOUNT_LENGTH];			// 수신자 ID
	DWORD	ReceiverSeq;							// 수신자 순번
	WCHAR	Message[MAX_MESSAGE_LENGTH];			// 메시지
	DWORD	ProductSeq;								// 상품 순번
	WCHAR	ProductName[MAX_PRODUCTNAME_LENGTH];	// 상품 명
...
public:
	...
	WCHAR	Rank[MAX_RANK_LENGTH];				// 랭크
	long	ServerIndex;						// 서버 인덱스
	WCHAR	strMemberNo[MAX_CHANNELING_LENGTH];	// 채널링 memberno
};
...
// C->S : MU_GB, SUN_GB : DeductMileageFlag 추가 버전
class MSG_CLIENT_BUYPRODUCT_GB_EX : public MSG_REQUEST_BASE<MSG_CLIENT_BUYPRODUCT_GB_EX>
{
public:
	MSG_CLIENT_BUYPRODUCT_GB_EX(long nGameCode)
		: MSG_REQUEST_BASE<MSG_CLIENT_BUYPRODUCT_GB_EX>(PROTOCOL_CLIENT_BUYPRODUCT_GB_EX)
	{
		GameCode = nGameCode;
		AccountSeq = 0;
		PackageSeq = PriceSeq = SalesZone = DisplaySeq = Class = Level = ServerIndex = CashTypeCode = 0;
...
// C->S : MU_GB, SUN_GB : DeductMileageFlag & AccessIP 추가 버전
class MSG_CLIENT_BUYPRODUCT_GB_EX_ADDIP : public MSG_REQUEST_BASE<MSG_CLIENT_BUYPRODUCT_GB_EX_ADDIP>
{
public:
	MSG_CLIENT_BUYPRODUCT_GB_EX_ADDIP(long nGameCode)
		: MSG_REQUEST_BASE<MSG_CLIENT_BUYPRODUCT_GB_EX_ADDIP>(PROTOCOL_CLIENT_BUYPRODUCT_GB_EX_ADDIP)
	{
		GameCode = nGameCode;
		AccountSeq = 0;
		PackageSeq = PriceSeq = SalesZone = DisplaySeq = Class = Level = ServerIndex = CashTypeCode = 0;
...
// C->S : GB_MU, GB_SUN : DeductMileageFlag 추가 버전
class MSG_CLIENT_GIFTPRODUCT_GB_EX : public MSG_REQUEST_BASE<MSG_CLIENT_GIFTPRODUCT_GB_EX>
{
public:
	MSG_CLIENT_GIFTPRODUCT_GB_EX(long nGameCode)
		: MSG_REQUEST_BASE<MSG_CLIENT_GIFTPRODUCT_GB_EX>(PROTOCOL_CLIENT_GIFTPRODUCT_GB_EX)
	{
		GameCode = nGameCode; 
		SenderSeq = ReceiverSeq = 0;
		SenderServerIndex = ReceiverServerIndex = PackageSeq = PriceSeq = SalesZone = DisplaySeq = CashTypeCode = 0;
...
// C->S : GB_MU, GB_SUN : DeductMileageFlag & AccessIP 추가 버전
class MSG_CLIENT_GIFTPRODUCT_GB_EX_ADDIP : public MSG_REQUEST_BASE<MSG_CLIENT_GIFTPRODUCT_GB_EX_ADDIP>
{
public:
	MSG_CLIENT_GIFTPRODUCT_GB_EX_ADDIP(long nGameCode)
		: MSG_REQUEST_BASE<MSG_CLIENT_GIFTPRODUCT_GB_EX_ADDIP>(PROTOCOL_CLIENT_GIFTPRODUCT_GB_EX_ADDIP)
	{
		GameCode = nGameCode; 
		SenderSeq = ReceiverSeq = 0;
		SenderServerIndex = ReceiverServerIndex = PackageSeq = PriceSeq = SalesZone = DisplaySeq = CashTypeCode = 0;
...
///////////////////////////////// 전체 보관함 조회 : 보관함 만료시점 표시 추가 /////////////////////////////////

// C->S : 전체 보관함 조회 : 보관함 만료시점 표시 추가
class MSG_CLIENT_STORAGELIST_EX : public MSG_REQUEST_BASE<MSG_CLIENT_STORAGELIST_EX>
{
public:
	MSG_CLIENT_STORAGELIST_EX() 
		: MSG_REQUEST_BASE<MSG_CLIENT_STORAGELIST_EX>(PROTOCOL_CLIENT_STORAGELIST_EX)
	{
		AccountSeq = 0;
		SalesZone = 0;
	}
...
// S->C : 전체 보관함 조회 : 보관함 만료시점 표시 추가
class MSG_SERVER_STORAGELIST_EX : public MSG_RESPONSE_BASE<MSG_SERVER_STORAGELIST_EX>
{
public:
	MSG_SERVER_STORAGELIST_EX()
		: MSG_RESPONSE_BASE<MSG_SERVER_STORAGELIST_EX>(PROTOCOL_SERVER_STORAGELIST_EX)
	{
		PackHeader = dwPacketSize;
		AccountSeq = 0;
		ListCount = 0;
...
///////////////////////////////// 한 페이지 보관함 조회 : 보관함 만료시점 표시 추가/////////////////////////////////

// C->S : 한 페이지 보관함 조회 : 보관함 만료시점 표시 추가
class MSG_CLIENT_STORAGELIST_PAGE_EX : public MSG_REQUEST_BASE<MSG_CLIENT_STORAGELIST_PAGE_EX>
{
public:
	MSG_CLIENT_STORAGELIST_PAGE_EX() 
		: MSG_REQUEST_BASE<MSG_CLIENT_STORAGELIST_PAGE_EX>(PROTOCOL_CLIENT_STORAGELIST_PAGE_EX)
	{
		AccountSeq = 0;
		SalesZone = PageSize = NowPage = 0;
		GiftMsgFlag = true;
...
// S->C : 한 페이지 보관함 조회 : 보관함 만료시점 표시 추가
class MSG_SERVER_STORAGELIST_PAGE_EX : public MSG_RESPONSE_BASE<MSG_SERVER_STORAGELIST_PAGE_EX>
{
public:
	MSG_SERVER_STORAGELIST_PAGE_EX()
		: MSG_RESPONSE_BASE<MSG_SERVER_STORAGELIST_PAGE_EX>(PROTOCOL_SERVER_STORAGELIST_PAGE_EX)
	{
		PackHeader = dwPacketSize;
		AccountSeq = 0;
		ListCount = NowPage = TotalPage = TotalRecord = 0;
...
// C->S : 보관함 아이템 사용하기
class MSG_CLIENT_STORAGEUSE_EX : public MSG_REQUEST_BASE<MSG_CLIENT_STORAGEUSE_EX>
{
public:
	MSG_CLIENT_STORAGEUSE_EX() 
		: MSG_REQUEST_BASE<MSG_CLIENT_STORAGEUSE_EX>(PROTOCOL_CLIENT_STORAGEUSE_EX)
	{
		AccountSeq = IPAddress = 0;
		StorageSeq = StorageItemSeq = Class = Level = ServerIndex = 0;
		StorageItemType = 0;
...
// S->C : 보관함 아이템 사용하기
class MSG_SERVER_STORAGEUSE_EX : public MSG_RESPONSE_BASE<MSG_SERVER_STORAGEUSE_EX>
{
public:
	MSG_SERVER_STORAGEUSE_EX() 
		: MSG_RESPONSE_BASE<MSG_SERVER_STORAGEUSE_EX>(PROTOCOL_SERVER_STORAGEUSE_EX)
	{
		PackHeader = dwPacketSize;
		AccountSeq = 0;
		ProductSeq = StorageSeq = StorageItemSeq = 0;
...
public:
	...
	long	StorageSeq;						// 보관함 순번
	long	StorageItemSeq;					// 보관함 Or 상품 순번
	int		CashType;						// CashType : 508 (C), 509 (P)
...
// C->S : 보관함 아이템 사용하기 : 결과값 DeductMileageFlag 추가
class MSG_CLIENT_STORAGEUSE_EX_DEDUCTMILEAGEFLAG : public MSG_REQUEST_BASE<MSG_CLIENT_STORAGEUSE_EX_DEDUCTMILEAGEFLAG>
{
public:
	MSG_CLIENT_STORAGEUSE_EX_DEDUCTMILEAGEFLAG() 
		: MSG_REQUEST_BASE<MSG_CLIENT_STORAGEUSE_EX_DEDUCTMILEAGEFLAG>(PROTOCOL_CLIENT_STORAGEUSE_EX_DEDUCTMILEAGEFLAG)
	{
		AccountSeq = IPAddress = 0;
		StorageSeq = StorageItemSeq = Class = Level = ServerIndex = 0;
		StorageItemType = 0;
...
// S->C : 보관함 아이템 사용하기 : 결과값 DeductMileageFlag 추가
class MSG_SERVER_STORAGEUSE_EX_DEDUCTMILEAGEFLAG : public MSG_RESPONSE_BASE<MSG_SERVER_STORAGEUSE_EX_DEDUCTMILEAGEFLAG>
{
public:
	MSG_SERVER_STORAGEUSE_EX_DEDUCTMILEAGEFLAG() 
		: MSG_RESPONSE_BASE<MSG_SERVER_STORAGEUSE_EX_DEDUCTMILEAGEFLAG>(PROTOCOL_SERVER_STORAGEUSE_EX_DEDUCTMILEAGEFLAG)
	{
		PackHeader = dwPacketSize;
		AccountSeq = 0;
		ProductSeq = StorageSeq = StorageItemSeq = 0;
...
public:
	...
	long	StorageSeq;						// 보관함 순번
	long	StorageItemSeq;					// 보관함 Or 상품 순번
	bool	DeductMileageFlag;				// false : 캐시상품(0), true : 마일리지상품(1)
