...
void CShopEH_AR::WriteLog(char* szMsg)
{
	...
	*(_tcsrchr( szModule, '\\' ) ) = 0;
	...
	StringCchPrintf( szFilePath, MAX_PATH, _T("%s\\ClientDialog_ShopClientAR.log"), szModule );
