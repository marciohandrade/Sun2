...
typedef const long long *xpcint64;

typedef unsigned long long xuint64;
typedef unsigned long long *xpuint64;
typedef unsigned const long long *xpcuint64;
#else
...
#define X_SUCCESS 0
#define X_SUCCEEDED(s) (((s) & 0x80000000) == 0)
...
#define X_E_INSUFFICIENT_LOCAL_BUFFER	MAKE_E_XSTATUS(XM_BASE, 11)

#define X_E_WIN32					0xE0FF0000
#endif
