...
#define SQL_SORTFLDLMT         255     /* Maximum size of field for sort      */
...
{
   unsigned long type; /* Type  of bind/prep/rebind option */
   unsigned long val; /* Value of bind/prep/rebind option */
};
...
#define SQL_NUM_OPTS           71      /* # of PREP/BIND/REBIND options       */
...
#define SQL_DYNAMICRULES_BIND  1       /* Dynamic SQL in package will use     */
                                       ...
                                       /* package                             */
#define SQL_DYNAMICRULES_INVOKE 2      /* Dynamic SQL in UDF or stored        */
                                       /* procedure will use authid of        */
                                       /* invoker of UDF or stored procedure  */
#define SQL_DYNAMICRULES_DEFINE 3      /* Dynamic SQL in UDF or stored        */
                                       /* procedure will use authid of        */
                                       /* definer of UDF or stored procedure  */
