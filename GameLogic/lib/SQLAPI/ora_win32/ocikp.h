/*
 * $Header: ocikp.h 20-sep-99.18:43:34 porangas Exp $
 */
...
/* 
   ...
   MODIFIED   (MM/DD/YY)
   porangas    09/20/99 - correct lines that exceed 80 characters:bug#974710
...
Syntax
sword OCILobIsTemporary(OCISvcCtx         *svchp,
                        OCIError          *errhp,
                        OCILobLocator     *locp,
...
*/
sword OCIMultiByteToWideChar(/*_ dvoid *envhp, OCIWchar *dst, CONST OraText *src,
                             size_t *rsize _*/);
