...
//	COleDateTimeSpan GetDataDateTimeSpan() const;
	...
	const char* GetChildDatachar() const										{ return GetChildData().c_str(); };
	SHORT GetChildDataShort() const												{ int val=0; _stscanf(GetChildData().c_str(),_T("%d"),&val); return  (SHORT)val; };
	INT64 GetChildDataInt64() const												{ INT64 val=0; _stscanf(GetChildData().c_str(),_T("%I64d"),&val); return  val; };
	...
	USHORT GetChildDataUSHORT() const											{ int val=0; _stscanf(GetChildData().c_str(),_T("%u"),&val); return  (USHORT)val; };
	BYTE GetChildDataBYTE() const												{ BYTE val=0; _stscanf(GetChildData().c_str(),_T("%c"),&val); return  val;	};
...
//	COleDateTime GetChildAttribDateTime(LPCTSTR szAttrib ) const				{ 	COleDateTime t; t.ParseDateTime(GetChildAttrib(szAttrib).c_str()); return t;};
    ...
    bool AddElemEx(LPCTSTR szName, bool _bool )									{	return AddElem(szName, (_bool) ? _T("1"):_T("0"));};
	bool AddElemEx(LPCTSTR szName, int _int )									{	sprintf(m_szTemp, _T("%d"),_int);	return AddElem(szName,m_szTemp);
	};

	bool AddElemEx(LPCTSTR szName, UINT _UINT )									{	sprintf(m_szTemp,_T("%u"),_UINT);		return AddElem(szName,m_szTemp);};
	bool AddElemEx(LPCTSTR szName, DWORD _DWORD )								{	sprintf(m_szTemp,_T("%u"),_DWORD);	return AddElem(szName,m_szTemp);};
	bool AddElemEx(LPCTSTR szName, long _long )									{	sprintf(m_szTemp,_T("%d"),_long);		return AddElem(szName,m_szTemp);};
	bool AddElemEx(LPCTSTR szName, float _float )								{	sprintf(m_szTemp,_T("%g"),_float);	return AddElem(szName,m_szTemp);};
	bool AddElemEx(LPCTSTR szName, double _double )								{	sprintf(m_szTemp,_T("%g"),_double);	return AddElem(szName,m_szTemp);};
...
//	bool AddElemEx(LPCTSTR szName, const COleDateTimeSpan& _ts)					{	return AddElem(szName,_ts.Format(_T("%D,%H:%M:%S")));};
	bool AddElemEx(LPCTSTR szName, const std::vector<double>& _v )				{	CSTL2String<double>::ToString(_v, m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::vector<float>& _v )				{	CSTL2String<float>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::vector<int>& _v )					{	CSTL2String<int>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::vector<BYTE>& _v )				{	CSTL2String<BYTE>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::vector<short>& _v )				{	CSTL2String<short>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::vector<long>& _v )				{	CSTL2String<long>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::valarray<double>& _v )			{	CSTL2String<double>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::valarray<float>& _v )				{	CSTL2String<float>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::valarray<int>& _v )				{	CSTL2String<int>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::valarray<BYTE>& _v )				{	CSTL2String<BYTE>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::valarray<short>& _v )				{	CSTL2String<short>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::valarray<long>& _v )				{	CSTL2String<long>::ToString(_v,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::list<UINT>& _l )					{	CSTL2String<UINT>::ToString(_l,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::list<double>& _l )				{	CSTL2String<double>::ToString(_l,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::list<float>& _l )					{	CSTL2String<float>::ToString(_l,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::list<int>& _l )					{	CSTL2String<int>::ToString(_l,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};
	bool AddElemEx(LPCTSTR szName, const std::list<BYTE>& _l )					{	CSTL2String<BYTE>::ToString(_l,m_strTemp);	return AddElem(szName,m_strTemp.c_str());};

	bool AddChildElemEx(LPCTSTR szName, char* _char )							{	sprintf(m_szTemp,_T("%s"),_char);		return AddChildElem(szName,m_szTemp);};
	//bool AddChildElemEx(LPCTSTR szName, bool _bool )							{	return AddChildElem(szName, (_bool) ? _T("true"):_T("false"));};
    bool AddChildElemEx(LPCTSTR szName, bool _bool )							{	return AddChildElem(szName, (_bool) ? _T("1"):_T("0"));};
	bool AddChildElemEx(LPCTSTR szName, WORD _word )							{	sprintf(m_szTemp,_T("%d"),_word);		return AddChildElem(szName,m_szTemp);};
	bool AddChildElemEx(LPCTSTR szName, SHORT _short )							{	sprintf(m_szTemp,_T("%d"),_short);		return AddChildElem(szName,m_szTemp);};
	bool AddChildElemEx(LPCTSTR szName, int _int )								{	sprintf(m_szTemp,_T("%d"),_int);		return AddChildElem(szName,m_szTemp);};
	bool AddChildElemEx(LPCTSTR szName, DWORD64 _DWORD64 )						{	sprintf(m_szTemp,_T("%I64u"),_DWORD64);		return AddChildElem(szName,m_szTemp);};
	bool AddChildElemEx(LPCTSTR szName, UINT _UINT )							{	sprintf(m_szTemp,_T("%u"),_UINT);		return AddChildElem(szName,m_szTemp);};
	bool AddChildElemEx(LPCTSTR szName, INT64 _varint64 )						{	sprintf(m_szTemp,_T("%I64d"),_varint64);	return AddChildElem(szName,m_szTemp);};
	bool AddChildElemEx(LPCTSTR szName, DWORD _DWORD )							{	sprintf(m_szTemp,_T("%u"),_DWORD);	return AddChildElem(szName,m_szTemp);};
	bool AddChildElemEx(LPCTSTR szName, long _long )							{	sprintf(m_szTemp,_T("%d"),_long);		return AddChildElem(szName,m_szTemp);};
	bool AddChildElemEx(LPCTSTR szName, float _float )							{	sprintf(m_szTemp,_T("%g"),_float);	return AddChildElem(szName,m_szTemp);};
	bool AddChildElemEx(LPCTSTR szName, double _double )						{	sprintf(m_szTemp,_T("%g"),_double);	return AddChildElem(szName,m_szTemp);};
...
//	bool AddChildElemExn(LPCTSTR szName, const COleDateTimeSpan& _ts)			{	return AddChildElem(szName,_ts.Format(_T("%D,%H:%M:%S")));};
	bool AddChildElemEx(LPCTSTR szName, const std::vector<double>& _v)			{	CSTL2String<double>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::vector<float>& _v)			{	CSTL2String<float>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::vector<int>& _v)				{	CSTL2String<int>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::vector<BYTE>& _v)			{	CSTL2String<BYTE>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::vector<short>& _v)			{	CSTL2String<short>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::vector<long>& _v)			{	CSTL2String<long>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::valarray<double>& _v )		{	CSTL2String<double>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::valarray<float>& _v )		{	CSTL2String<float>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::valarray<int>& _v )			{	CSTL2String<int>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::valarray<BYTE>& _v )			{	CSTL2String<BYTE>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::valarray<short>& _v )		{	CSTL2String<short>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::valarray<long>& _v )			{	CSTL2String<long>::ToString(_v,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::list<UINT>& _l)				{	CSTL2String<UINT>::ToString(_l,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::list<double>& _l)			{	CSTL2String<double>::ToString(_l,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::list<float>& _l)				{	CSTL2String<float>::ToString(_l,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::list<int>& _l)				{	CSTL2String<int>::ToString(_l,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};
	bool AddChildElemEx(LPCTSTR szName, const std::list<BYTE>& _l)				{	CSTL2String<BYTE>::ToString(_l,m_strTemp);	return AddChildElem(szName,m_strTemp.c_str());};

	bool AddAttribEx(LPCTSTR szName, bool _bool )								{	return AddAttrib(szName, (_bool) ? _T("true"):_T("false"));};
	bool AddAttribEx(LPCTSTR szName, int _int )									{	sprintf(m_szTemp,_T("%d"),_int);			return AddAttrib(szName,m_szTemp);};
	bool AddAttribEx(LPCTSTR szName, UINT _UINT )								{	sprintf(m_szTemp,_T("%u"),_UINT);		return AddAttrib(szName,m_szTemp);};
	bool AddAttribEx(LPCTSTR szName, DWORD _DWORD )								{	sprintf(m_szTemp,_T("%u"),_DWORD);	return AddAttrib(szName,m_szTemp);};
	bool AddAttribEx(LPCTSTR szName, long _long )								{	sprintf(m_szTemp,_T("%d"),_long);		return AddAttrib(szName,m_szTemp);};
	bool AddAttribEx(LPCTSTR szName, float _float )								{	sprintf(m_szTemp,_T("%g"),_float);	return AddAttrib(szName,m_szTemp);};
	bool AddAttribEx(LPCTSTR szName, double _double )							{	sprintf(m_szTemp,_T("%g"),_double);	return AddAttrib(szName,m_szTemp);};
...
//	bool AddAttribEx(LPCTSTR szName, const COleDateTimeSpan& _ts)				{	return AddAttrib(szName,_ts.Format(_T("%D,%H:%M:%S")));};
	bool AddAttribEx(LPCTSTR szName, const std::vector<double>& _v )			{	CSTL2String<double>::ToString(_v,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::vector<float>& _v )				{	CSTL2String<float>::ToString(_v,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::vector<int>& _v )				{	CSTL2String<int>::ToString(_v,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::vector<BYTE>& _v )				{	CSTL2String<BYTE>::ToString(_v,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::vector<short>& _v )				{	CSTL2String<short>::ToString(_v,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::vector<long>& _v )				{	CSTL2String<long>::ToString(_v,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::valarray<double>& _v )			{	CSTL2String<double>::ToString(_v,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::valarray<float>& _v )			{	CSTL2String<float>::ToString(_v,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::valarray<int>& _v )				{	CSTL2String<int>::ToString(_v,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::valarray<BYTE>& _v )			{	CSTL2String<BYTE>::ToString(_v,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::list<UINT>& _l )				{	CSTL2String<UINT>::ToString(_l,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::list<double>& _l )				{	CSTL2String<double>::ToString(_l,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::list<float>& _l )				{	CSTL2String<float>::ToString(_l,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::list<int>& _l )					{	CSTL2String<int>::ToString(_l,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};
	bool AddAttribEx(LPCTSTR szName, const std::list<BYTE>& _l )				{	CSTL2String<BYTE>::ToString(_l,m_strTemp);	return AddAttrib(szName,m_strTemp.c_str());};

	bool AddChildAttribEx(LPCTSTR szName, bool _bool )							{	return AddChildAttrib(szName, (_bool) ? _T("true"):_T("false"));};
	bool AddChildAttribEx(LPCTSTR szName, int _int )							{	sprintf(m_szTemp,_T("%d"),_int);		return AddChildAttrib(szName,m_szTemp);};
	bool AddChildAttribEx(LPCTSTR szName, UINT _UINT )							{	sprintf(m_szTemp,_T("%u"),_UINT);		return AddChildAttrib(szName,m_szTemp);};
	bool AddChildAttribEx(LPCTSTR szName, DWORD _DWORD )						{	sprintf(m_szTemp,_T("%u"),_DWORD);	return AddChildAttrib(szName,m_szTemp);};
	bool AddChildAttribEx(LPCTSTR szName, long _long )							{	sprintf(m_szTemp,_T("%d"),_long);		return AddChildAttrib(szName,m_szTemp);};
	bool AddChildAttribEx(LPCTSTR szName, float _float )						{	sprintf(m_szTemp,_T("%g"),_float);	return AddChildAttrib(szName,m_szTemp);};
	bool AddChildAttribEx(LPCTSTR szName, double _double )						{	sprintf(m_szTemp,_T("%g"),_double);	return AddChildAttrib(szName,m_szTemp);};
...
//	bool AddChildAttribEx(LPCTSTR szName, const COleDateTimeSpan& _ts)			{	return AddChildAttrib(szName,_ts.Format(_T("%D,%H:%M:%S")));};
	bool AddChildAttribEx(LPCTSTR szName, const std::vector<double>& _v )		{	CSTL2String<double>::ToString(_v,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::vector<float>& _v )		{	CSTL2String<float>::ToString(_v,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::vector<int>& _v )			{	CSTL2String<int>::ToString(_v,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::vector<BYTE>& _v )			{	CSTL2String<BYTE>::ToString(_v,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::vector<short>& _v )		{	CSTL2String<short>::ToString(_v,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::vector<long>& _v )			{	CSTL2String<long>::ToString(_v,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::valarray<double>& _v )		{	CSTL2String<double>::ToString(_v,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::valarray<float>& _v )		{	CSTL2String<float>::ToString(_v,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::valarray<int>& _v )		{	CSTL2String<int>::ToString(_v,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::valarray<BYTE>& _v )		{	CSTL2String<BYTE>::ToString(_v,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::list<UINT>& _l )			{	CSTL2String<UINT>::ToString(_l,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::list<double>& _l )			{	CSTL2String<double>::ToString(_l,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::list<float>& _l )			{	CSTL2String<float>::ToString(_l,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::list<int>& _l )			{	CSTL2String<int>::ToString(_l,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	bool AddChildAttribEx(LPCTSTR szName, const std::list<BYTE>& _l )			{	CSTL2String<BYTE>::ToString(_l,m_strTemp);	return AddChildAttrib(szName,m_strTemp.c_str());};
	//@}
...
//	bool FindGetData(LPCTSTR szName, COleDateTimeSpan& _ts);
	...
	bool FindGetChildData(LPCTSTR szName, char* _tchar);
	bool FindGetChildData(LPCTSTR szName, SHORT& _short);
	...
	bool FindGetChildData(LPCTSTR szName, INT64& _varint64); // CHANGES: f101206.2L, change name to avoid type conflict
...
//	bool FindGetChildData(LPCTSTR szName, COleDateTimeSpan& _ts);
	...
	{	
		...
		{
			std::string str = m_sNameSpace +  szName;
			return CMarkupSTL::AddElem( str.c_str(), szData);
		}
	};
	...
	{	
		...
		{
			std::string str = m_sNameSpace + szName;
			return CMarkupSTL::AddChildElem( str.c_str(), szData);
		}
	};
	...
	{	
		if (szName==NULL) 
			...
			{
				std::string str = m_sNameSpace+szName;
				return CMarkupSTL::FindElem( str.c_str());
			}
	};
	...
	{	
		if (szName==NULL) 
			...
			{
				std::string str = m_sNameSpace+szName;
				return CMarkupSTL::FindChildElem(str.c_str());
			}
	};
...
protected:
	...
	DWORD m_dwMode;
	//! encoding string
	std::string m_strEncodingString;
