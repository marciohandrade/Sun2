...
//	const char* GetData() const { return x_GetData(m_iPos).c_str(); };
//	const char* GetChildData() const { return x_GetData(m_iPosChild).c_str(); };
//	const char* GetAttrib( const char* szAttrib ) const { return x_GetAttrib(m_iPos,szAttrib).c_str(); };
//	const char* GetChildAttrib( const char* szAttrib ) const { return x_GetAttrib(m_iPosChild,szAttrib).c_str(); };
	...
	bool AddElem( const char* szName, int nValue ) { return x_AddElem(szName,nValue,false,false); };
	bool InsertElem( const char* szName, int nValue ) { return x_AddElem(szName,nValue,true,false); };
	bool AddChildElem( const char* szName, int nValue ) { return x_AddElem(szName,nValue,false,true); };
	bool InsertChildElem( const char* szName, int nValue ) { return x_AddElem(szName,nValue,true,true); };
...
protected:
	...
	bool x_AddElem( const char* szName, int nValue, bool bInsert, bool bAddChild );
