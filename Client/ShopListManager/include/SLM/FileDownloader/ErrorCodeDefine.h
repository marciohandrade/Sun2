...
#define GU_LAST_PATH_ERROR				(0x00000002 | GU_FAILED)

// 버전 에러 코드
#define VS_FAILED						0x10000000
#define VS_EXCEPTION					(0x00000001 | VS_FAILED)
...
#define VS_NO_DLL_INFO					(0x00000007 | VS_FAILED)
#define VS_LOADLIBRARY					(0x00000008 | VS_FAILED)
#define VS_GETPROCADDR					(0x00000009 | VS_FAILED)
#define VS_CHK_VER_IN_ADAPTER			(0x0000000A | VS_FAILED)
...
#define PT_CHECKFILES					(0x00000007 | PT_FAILED)
#define PT_INVALID_CHECKLIST			(0x00000008 | PT_FAILED)
#define PT_COMPULSION_FILECHECK			(0x00000009 | PT_FAILED)
