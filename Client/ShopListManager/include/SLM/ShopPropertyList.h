...
public:
	...
	bool GetNext(CShopProperty*& Property);							// overload : 포인터 사용
	bool GetValueByKey(int nPropertySeq, CShopProperty*& Property);	// overload : 포인터 사용
	bool GetValueByIndex(int nIndex, CShopProperty*& Property);		// overload : 포인터 사용
