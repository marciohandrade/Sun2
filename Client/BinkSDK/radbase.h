...
// __RADBIGENDIAN__ means processor is big-endian (680x0, PPC)
  ...
  #define RADCOPYRIGHT "Copyright (C) 1994-2005, RAD Game Tools, Inc."
    ...
    #if (!defined(__RADDOS__) && !defined(__RADWIN__) && !defined(__RADMAC__) && !defined(__RADNGC__) && !defined(__RADNDS__) && !defined(__RADXBOX__) && !defined(__RADXENON__) && !defined(__RADLINUX__) && !defined(__RADPS2__))
    ...
    #if defined(__RADNGC__) || defined( __RADPS2__) || defined(__RADNDS__)
