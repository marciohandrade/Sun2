...
#define BINKSUBVERSION 6
#define BINKVERSION "1.8g"
#define BINKDATE    "2005-09-28"
...
RADEXPFUNC void RADEXPLINK BinkControlCPUFeatures( S32 use, S32 dont_use );
  ...
  RADEXPFUNC BINKSNDOPEN RADEXPLINK BinkOpenXAudio(U32 param); // don't call directly
