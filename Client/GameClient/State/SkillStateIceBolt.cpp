...
BOOL SkillStateIceBolt::OnProcessCustemEvent( int nEventIndex, Object* pOwner, DWORD CurTime,DWORD dwTick )
{
	if( nEventIndex == 1 )
	{
        ...
        if( pCharacter != NULL && pTarget != NULL )
        {
            ...
            pProjectile->CreateEffect( StrToWzID("k440"), pCharacter->GetObjectKey(), pTarget->GetObjectKey() );
        ...
        if( pCharacter != NULL && pTarget != NULL )
        {
            ...
            pProjectile->SetLifeTime( MoveTime + 133 );

            pProjectile->CreateEffect( StrToWzID("k441"), pCharacter->GetObjectKey(), pTarget->GetObjectKey() );
