...
SkillStateDashStun::SkillStateDashStun()
: m_bStartMove( FALSE )
, m_dwCloneKey( 0 )
, m_dwCrushTime( 0 )
{
...
STATECHANGE::TYPE SkillStateDashStun::OnStart(Object* pOwner, DWORD CurTime)
{
...
STATEPROCESS::TYPE SkillStateDashStun::OnProcess(Object* pOwner, DWORD CurTime,DWORD dwTick)
{
...
void SkillStateDashStun::_AddHitEffect( Character* pCharacter )
{
	// 타격 이펙트
