...
BOOL SkillStateWindBolt::OnProcessCustemEvent( int nEventIndex, Object* pOwner, DWORD CurTime,DWORD dwTick )
{
	if( nEventIndex == 1 )
	{
        ...
        if( pCharacter != NULL && pTarget != NULL )
        {
            ...
            DWORD MoveTime = max(100, (DWORD)(1333.0f * (float)(fLength/range)) );
            ...
            pProjectile->SetRemainTime( 1000 );

            pProjectile->CreateEffect( StrToWzID("K451"), pCharacter->GetObjectKey(), pTarget->GetObjectKey() );
        ...
        if( pCharacter != NULL && pTarget != NULL )
        {
            ...
            pProjectile->SetLifeTime( MoveTime );
            pProjectile->SetRemainTime( 2000 );

            pProjectile->CreateEffect( StrToWzID("K450"), pCharacter->GetObjectKey(), pTarget->GetObjectKey() );
