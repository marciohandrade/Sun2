...
BOOL SkillStateIceDagger::OnProcessCustemEvent( int nEventIndex, Object* pOwner, DWORD CurTime,DWORD dwTick )
{
	if( nEventIndex == 1 )
	{
        ...
        if( pCharacter != NULL && pTarget != NULL )
        {
            ...
            pProjectile->CreateEffect( StrToWzID("E011"), pCharacter->GetObjectKey(), pTarget->GetObjectKey() );
