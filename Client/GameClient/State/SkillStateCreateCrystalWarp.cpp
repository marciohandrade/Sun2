...
SkillStateCreateCrystalWarp::SkillStateCreateCrystalWarp()
{
}

SkillStateCreateCrystalWarp::~SkillStateCreateCrystalWarp(void)
{
}

BOOL SkillStateCreateCrystalWarp::CanTransite(Object* pOwner, DWORD CurTime, StateBase* pToTransiteState)
{

	return TRUE;
}

STATECHANGE::TYPE SkillStateCreateCrystalWarp::OnStart(Object* pOwner, DWORD CurTime)
{
	...
	if (g_pHero)
	{
		...
		if(g_pHero->GetObjectKey()==pChr->GetObjectKey())
		{
			...
			SendPacket.m_wvPos = g_HeroInput.GetPickingPosition();
			SendPacket.m_dwCrystalWarpObjKey = 0;
			SendPacket.m_byCommand = eCRYSTALWARP_COMMAND_CREATE;
...
STATEPROCESS::TYPE SkillStateCreateCrystalWarp::OnProcess(Object* pOwner, DWORD CurTime,DWORD dwTick)
{
...
STATECHANGE::TYPE SkillStateCreateCrystalWarp::OnEnd(Object* pOwner, DWORD CurTime)
{
	return STATECHANGE::SUCCESS;
}