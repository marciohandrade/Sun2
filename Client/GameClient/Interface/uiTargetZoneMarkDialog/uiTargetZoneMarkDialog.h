...
class uiTargetZoneMarkDialog: public uiBase
{
...
public:
	uiTargetZoneMarkDialog(InterfaceManager *pUIMan);
	virtual ~uiTargetZoneMarkDialog();
...
private:
	static WzID constols_id_[DIALOG_MAX];
...
#else
	CCtrlPictureWZ* zonemark_picture_[MAX_ZONEMARK];
#endif
