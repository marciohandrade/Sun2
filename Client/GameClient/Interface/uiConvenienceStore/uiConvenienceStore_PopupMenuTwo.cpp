...
//------------------------------------------------------------------------------ 
const DWORD uiConvenienceStore_PopupMenuTwo::kDialog_ID = StrToWzID("0475");;

//------------------------------------------------------------------------------ 
uiConvenienceStore_PopupMenuTwo::uiConvenienceStore_PopupMenuTwo(InterfaceManager* ui_man) : uiConvenienceStore_PopupMenu(ui_man)
{
...
//------------------------------------------------------------------------------ 
uiConvenienceStore_PopupMenuTwo::~uiConvenienceStore_PopupMenuTwo( void )
{
    Release();
}
//------------------------------------------------------------------------------ 
void uiConvenienceStore_PopupMenuTwo::Init(CDrawBase* drawbase)
{
    //ASSERT(is_result && "uiConvenienceStore_PopupMenuTwo::Init false");
}
//------------------------------------------------------------------------------ 
void uiConvenienceStore_PopupMenuTwo::Release(void)
{

}
//------------------------------------------------------------------------------ 
void uiConvenienceStore_PopupMenuTwo::OnShowWindow(BOOL val)
{
...
//------------------------------------------------------------------------------
void uiConvenienceStore_PopupMenuTwo::OnUpdateSolarDialog()
{
...
//------------------------------------------------------------------------------ 
void uiConvenienceStore_PopupMenuTwo::Process(DWORD tick)
{

}
//------------------------------------------------------------------------------ 
void uiConvenienceStore_PopupMenuTwo::NetworkProc(MSG_BASE* msgbase)
{

}
//------------------------------------------------------------------------------
void uiConvenienceStore_PopupMenuTwo::MessageProc(SI_MESSAGE* message)
{
    if (IsLock())
    {
        return;
...
//------------------------------------------------------------------------------
bool uiConvenienceStore_PopupMenuTwo::OnLButtonClick(SI_MESSAGE* message)
{
    bool result = true;
...
//------------------------------------------------------------------------------ 
void uiConvenienceStore_PopupMenuTwo::SetMenu(int button_index, DWORD string_code, bool is_enable, uiConvenienceStore_Dialog::PopupCommandType command_type, DWORD user_data)
{
...
//------------------------------------------------------------------------------ 
void uiConvenienceStore_PopupMenuTwo::Reset()
{
    uiConvenienceStore_PopupMenu::Reset();

    if (GetControlWZ_byPosition(kControl_Button_B001) &&
        GetControlWZ_byPosition(kControl_Button_B000) &&
        GetControlWZ_byPosition(kControl_Button_B002))
    {
        ...
        GetControlWZ_byPosition(kControl_Button_B002)->ShowWindowWZ(WZ_HIDE);
    }
}